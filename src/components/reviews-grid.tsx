// src\components\reviews-grid.tsx
"use client"
...
export default function ReviewsGrid() {
  ...
  return (
    <div className="space-y-8 p-8 bg-gradient-to-br from-[#e9ecef] to-[#40d5e2] dark:bg-gradient-to-br dark:from-[#e9ecef] dark:to-[#40d5e2] dark:to-gray-800 min-h-screen">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {currentReviews.map((review) => (
          <Card
            key={review.id}
            className="hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 bg-gradient-to-br from-[#e9ecef] to-[#40d5e2] dark:bg-gradient-to-br dark:from-[#e9ecef] dark:to-[#40d5e2] dark:bg-gray-800"
          >
