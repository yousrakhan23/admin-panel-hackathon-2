// src\components\customers-grid.tsx
"use client"
...
export default function CustomersGrid() {
  ...
  return (
    <div className="space-y-8 p-8 bg-gradient-to-br from-[#e9ecef] to-[#40d5e2] dark:bg-gradient-to-br dark:from-[#e9ecef] dark:to-[#40d5e2] min-h-screen">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {currentCustomers.map((customer) => (
          <Card
            key={customer.id}
            className="hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 bg-gradient-to-br from-[#e9ecef] to-[#40d5e2] dark:bg-gradient-to-br dark:from-[#e9ecef] dark:to-[#40d5e2]"
          >
