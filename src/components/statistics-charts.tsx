...
export default function StatisticsCharts() {
  return (
    <div className="space-y-8 p-8 bg-gradient-to-br from-[#e9ecef] to-[#40d5e2]  min-h-screen">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-gradient-to-br from-[#e9ecef] to-[#40d5e2] dark:bg-gradient-to-br dark:from-[#e9ecef] dark:to-[#40d5e2] dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow">
